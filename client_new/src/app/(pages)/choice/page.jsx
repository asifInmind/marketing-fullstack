...
function SelectAccountContent() {
  ...
  const accessToken =
    urlAccessToken ??
    "EAANNwrHSS7EBO98baLarQqy3CpdM5cr7nyAdmkA3oTDejtU7ka6GiOnBmtimNZB33ep71xqgFFJom4rXcAEX3irRBzfKQMViTBTyYiemWZCWdrZCApvySLDNzyXZBuBlNK6ZAGfv0QbjXQPVEoacpeyZBhZC5IeUCJdG8gcK9d0ljXEQWx8JJ9zNLmCWfjmz8ElBMBAvEcfySMmbKDhnN6hddHHrgZDZD";
    ...
    <div className="max-w-2xl mx-auto p-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Choose the account you want to manage campaigns for.
        </p>
      </div>
